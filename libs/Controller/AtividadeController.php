...
class AtividadeController extends AppBaseController {
    ...
    public function Query() {
        try {
            ...
            if ($page != '') {
                ...
                $atividades = $this->Phreezer->Query('AtividadeReporter', $criteria)->GetDataPage($page, $pagesize);
                ...
                // return all results
                $atividades = $this->Phreezer->Query('AtividadeReporter', $criteria);
                $output->rows = $atividades->ToObjectArray(true, $this->SimpleObjectParams());
    ...
    public function Create() {
        ...
        try {
            ...
            $entrega = $this->SafeGetVal($json, 'dataEntrega');
            if ($entrega != "") {
                $atividade->DataEntrega = date('Y-m-d H:i:s', strtotime($entrega));
            }else{
    ...
    public function Update() {
        ...
        try {
            ...
            $entrega = $this->SafeGetVal($json, 'dataEntrega', $atividade->DataEntrega);
            if ($entrega != "") {
