...
require_once("DAO/AtividadeCriteriaDAO.php");

/**
 * The AtividadeCriteria class extends AtividadeDAOCriteria and is used
 ...
 * @version 1.0
 */
class AtividadeCriteria extends AtividadeCriteriaDAO
{
