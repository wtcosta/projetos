...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Wt Projetos" />
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="./">Wt Projetos</a>
                            ...
                            <?php if (isset($this->currentUser)) { ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        ?>><a href="./users">Usu&aacute;rios</a></li>
                                        <li <?php
                                        if ($this->nav == 'roles') {
                                            echo 'class="active"';
                                        }
                                        ?>><a href="./roles">Fun&ccedil;&otilde;es</a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                            <li <?php
                            if ($this->nav == 'clientes') {
                                echo 'class="active"';
                            }
                            ?>><a href="./clientes">Clientes</a></li>
                            <li <?php
                            if ($this->nav == 'projetos') {
                                echo 'class="active"';
                            }
                            ?>><a href="./projetos">Projetos</a></li>
                            <li <?php
                            if ($this->nav == 'atividades') {
                                echo 'class="active"';
                            }
                            ?>><a href="./atividades">Atividades</a></li>
                        </ul>
                        </li>
                        </ul>
