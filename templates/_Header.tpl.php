					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
							<ul class="nav">
								...
								<?php } ?>
								<li <?php if ($this->nav=='atividades') { echo 'class="active"'; } ?>><a href="./atividades">Atividades</a></li>
								<li <?php if ($this->nav=='clientes') { echo 'class="active"'; } ?>><a href="./clientes">Clientes</a></li>
								<li <?php if ($this->nav=='projetos') { echo 'class="active"'; } ?>><a href="./projetos">Projetos</a></li>
								</ul>
								</li>
							</ul>
