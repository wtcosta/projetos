...
GlobalConfig::$CONNECTION_SETTING->DBName = "wesley_projetos";
GlobalConfig::$CONNECTION_SETTING->Username = "wesley_wt";
GlobalConfig::$CONNECTION_SETTING->Password = "Wtc0304!";
...
/** the root url of the application with trailing slash, for example http://localhost/wt projetos/ */
GlobalConfig::$ROOT_URL = 'http://projetos.wesleyteixeira.com.br/';
